...
3. AL FINAL, propone agendar una visita técnica presencial o llamada con un Ingeniero Electricista Colegiado de TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.`,
    ...
    AUTOMATIZACION: {
        ...
        systemPrompt: `Eres PILi, Ingeniera Especialista en Automatización y BMS de TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.
...
2. AL FINAL, sugiere agendar una presentación técnica o visita presencial con nuestro especialista de ingeniería.`,
    ...
    INCENDIOS: {
        ...
        systemPrompt: `Eres PILi, Ingeniera Especialista en Sistemas Contra Incendios de TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.
...
2. AL FINAL, invita a agendar una revisión técnica o visita en el local para evaluar el sistema de agua y detección.`,
    ...
    SEGURIDAD: {
        ...
        systemPrompt: `Eres PILi, Especialista en Seguridad Electrónica y Vigilancia 24/7 de TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.
...
2. AL FINAL, propone una evaluación en sitio para diseñar la distribución de cámaras y controles.`,
    ...
    ACABADOS: {
        ...
        systemPrompt: `Eres PILi, Especialista en Acabados Técnicos e Infraestructura Integrada de TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.
...
2. AL FINAL, invita a agendar una visita técnica para levantamiento de medidas en obra.`,
    ...
    ITSE: {
        ...
        systemPrompt: `Eres PILi, Especialista en Certificación ITSE (Inspección Técnica de Seguridad en Edificaciones) y Defensa Civil de TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.
...
2. AL FINAL, ofrece agendar una auditoría pre-inspección gratuita con un Ingeniero especialista en ITSE.`,
    ...
    BIM_MEP: {
        ...
        systemPrompt: `Eres PILi, Especialista Senior en Coordinación BIM / MEP 3D de TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.
...
2. AL FINAL, propone coordinar una revisión de planos o reunión con nuestro equipo BIM MEP.`,
    ...
    INTEGRAL: {
        ...
        systemPrompt: `Eres PILi, la Coordinadora General de Soluciones Integrales TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C. en Perú.
...
function generatePiliResponse(agent, userMessage, clienteNombre = "") {
    ...
    switch (agent.id) {
        case "ELECTRICIDAD":
            respuestaBase = `Estimado(a)${saludoNombre}, un gusto saludarle de parte de *TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.*\n\nRespecto a su consulta sobre instalaciones eléctricas, le comento que diseñamos y ensamblamos tableros normados (IEC 61439 / NEMA) y sistemas de pozo a tierra certificados con medición < 25 Ω según la Regla 060-712 del CNE-Utilización Perú.\n\nLe proponemos agendar una *evaluación técnica presencial en obra* o llamada con un Ingeniero Electricista Colegiado.`;
            break;
        case "AUTOMATIZACION":
            respuestaBase = `Estimado(a)${saludoNombre}, reciba un cordial saludo de *TESLA ELECTRICIDAD Y AUTOMATIZACIÓN S.A.C.*\n\nEn cuanto a su proyecto de automatización y BMS, integramos protocolos estándar (BACnet, Modbus, KNX) para el control de climatización (HVAC), iluminación y energía con un ahorro estimado de hasta 30% en consumo.\n\nPodemos coordinar una *presentación técnica o visita a sitio* para evaluar la arquitectura de control.`;
            break;
        case "INCENDIOS":
