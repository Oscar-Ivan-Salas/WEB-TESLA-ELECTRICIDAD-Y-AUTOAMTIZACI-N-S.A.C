...
/* Waves - portado a JavaScript puro desde React Bits (https://reactbits.dev)
   Uso:
     <div id="waves-bg" class="waves"></div>
     window.initWaves(document.getElementById('waves-bg'), { lineColor: 'rgba(255,184,0,0.18)', ... });
*/
(function () {
    'use strict';
    ...
    function initWaves(container, opts) {
        ...
        function setLines() {
            ...
            const xStart = (bounding.width - config.xGap * totalLines) / 2;
            const yStart = (bounding.height - config.yGap * totalPoints) / 2;
